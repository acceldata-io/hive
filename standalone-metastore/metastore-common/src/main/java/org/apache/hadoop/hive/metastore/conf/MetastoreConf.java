...
"The password for the bind user, to be used to search for the full name of the user being authenticated.\n" +
    ...
    METASTORE_CLIENT_LIST_TABLES_FAST_MODE("metastore.client.list.tables.fast.mode",
        "hive.metastore.client.list.tables.fast.mode", false,
        "When enabled, SHOW TABLES uses get_tables API returning only table names instead of " +
        "fetching full table objects. Improves performance for large table counts. Default is false."),
