...
class ColumnStatistics : public virtual ::apache::thrift::TBase {
 public:
  ...
  ColumnStatistics() : isStatsCompliant(0), engine("hive") {
  }
...
class SetPartitionsStatsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  SetPartitionsStatsRequest() : needMerge(0), writeId(-1LL), validWriteIdList(), engine("hive") {
  }
...
class TableStatsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  TableStatsRequest() : dbName(), tblName(), catName(), validWriteIdList(), engine("hive"), id(-1LL) {
  }
...
class PartitionsStatsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  PartitionsStatsRequest() : dbName(), tblName(), catName(), validWriteIdList(), engine("hive") {
  }
...
typedef struct _GetPartitionsByNamesRequest__isset {
  _GetPartitionsByNamesRequest__isset() : names(false), get_col_stats(false), processorCapabilities(false), processorIdentifier(false), engine(true), validWriteIdList(false), getFileMetadata(false), id(true) {}
  bool names :1;
...
class GetPartitionsByNamesRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  GetPartitionsByNamesRequest() : db_name(), tbl_name(), get_col_stats(0), processorIdentifier(), engine("hive"), validWriteIdList(), getFileMetadata(0), id(-1LL) {
  }
...
class GetTableRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  GetTableRequest() : dbName(), tblName(), catName(), validWriteIdList(), getColumnStats(0), processorIdentifier(), engine("hive"), id(-1LL) {
  }
