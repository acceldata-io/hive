...
public class MetricsConstants {
  ...
  public static final String TOTAL_NUM_OPEN_TXN_GAP_FILL_SKIPPED = "total_num_open_txn_gap_fill_skipped";
  public static final String TOTAL_NUM_OPEN_TXN_GAP_FILL_ABORTED = "total_num_open_txn_gap_fill_aborted";
