-- The file has some overlapping with upgrade-3.2.0-to-3.1.4.3.2.2.0-1.postgres.sql
SELECT 'Upgrading MetaStore schema from 3.1.3000 to 3.1.4.3.2.2.0-1';
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3000 to 3.1.4.3.2.2.0-1';
